...
using Android.Util;
using Android.Views;
using ThesisMethod.Droid.Effects;
...
namespace ThesisMethod.Droid.Effects
{
    public class TapWithPositionGestureEffect : PlatformEffect
    {
        ...
        {
            Debug.WriteLine("TapWithPositionGestureEffect called");
